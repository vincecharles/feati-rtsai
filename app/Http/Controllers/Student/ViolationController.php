    ...
    public function getStatistics(Request $request)
    {
        try {
            ...
            $stats = [
                ...
                'minor_violations' => Violation::where('student_id', $studentId)->where('severity_level', 'minor')->count(),
                'moderate_violations' => Violation::where('student_id', $studentId)->where('severity_level', 'moderate')->count(),
                'major_violations' => Violation::where('student_id', $studentId)->where('severity_level', 'major')->count(),
                'severe_violations' => Violation::where('student_id', $studentId)->where('severity_level', 'severe')->count(),
