<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="px-4 pb-3">
            <button type="button" onclick="toggleTheme()"
                    class="mt-2 inline-flex items-center justify-center rounded-md px-3 py-2 w-full
                           text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-900">
                <i class="fa-solid fa-moon dark:hidden me-2"></i>
                <i class="fa-solid fa-sun hidden dark:inline me-2"></i>
                Toggle theme
            </button>
        </div>
