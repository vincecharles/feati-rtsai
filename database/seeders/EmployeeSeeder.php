    ...
    public function run(): void
    {
        ...
        for ($i = 1; $i <= 3; $i++) {
            ...
            EmployeeProfile::create([
                ...
                'sex' => fake()->randomElement(['Male', 'Female']),
                'age' => fake()->numberBetween(28, 65),
                'mobile' => fake()->numerify('09#########'),
                'current_address' => fake()->address(),
                'date_hired' => fake()->dateTimeBetween('-12 years', 'now')->format('Y-m-d'),
                'position' => 'OSA',
        ...
        foreach ($deptHeadDepts as $dept) {
            ...
            EmployeeProfile::create([
                ...
                'first_name' => explode(' ', $user->name)[0],
                'last_name' => explode(' ', $user->name)[1] ?? 'Doe',
                'date_of_birth' => fake()->date('Y-m-d', '-45 years'),
                'sex' => fake()->randomElement(['Male', 'Female']),
                'age' => fake()->numberBetween(35, 65),
                'mobile' => fake()->numerify('09#########'),
                'current_address' => fake()->address(),
                'date_hired' => fake()->dateTimeBetween('-20 years', 'now')->format('Y-m-d'),
